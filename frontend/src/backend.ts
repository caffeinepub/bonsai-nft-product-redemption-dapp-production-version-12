...
import type { ExternalBlob as _ExternalBlob, ORIGYNMetadata as _ORIGYNMetadata, ProvenanceID as _ProvenanceID, PublicNFTData as _PublicNFTData, PublicORIGYNMetadata as _PublicORIGYNMetadata, PublicTransactionRecord as _PublicTransactionRecord, RedemptionRecord as _RedemptionRecord, Time as _Time, TransactionRecord as _TransactionRecord, TransactionType as _TransactionType, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async burnNFT(arg0: bigint): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getOwnedNFTs(): Promise<Array<PublicORIGYNMetadata>> {
        if (this.processError) {
            try {
    ...
    async getTransactionHistory(): Promise<Array<PublicTransactionRecord>> {
        if (this.processError) {
            try {
    ...
    async getUserNFTs(): Promise<Array<PublicNFTData>> {
        if (this.processError) {
            try {
...
async function from_candid_PublicNFTData_n44(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PublicNFTData): Promise<PublicNFTData> {
    return await from_candid_record_n45(_uploadFile, _downloadFile, value);
}
async function from_candid_PublicORIGYNMetadata_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PublicORIGYNMetadata): Promise<PublicORIGYNMetadata> {
    return await from_candid_record_n36(_uploadFile, _downloadFile, value);
}
async function from_candid_PublicTransactionRecord_n41(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PublicTransactionRecord): Promise<PublicTransactionRecord> {
    return await from_candid_record_n42(_uploadFile, _downloadFile, value);
}
async function from_candid_RedemptionRecord_n38(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RedemptionRecord): Promise<RedemptionRecord> {
    return await from_candid_record_n39(_uploadFile, _downloadFile, value);
}
async function from_candid_TransactionRecord_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TransactionRecord): Promise<TransactionRecord> {
...
async function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        discountCode: record_opt_to_undefined(from_candid_opt_n19(_uploadFile, _downloadFile, value.discountCode)),
        ...
        media_assets: await from_candid_vec_n20(_uploadFile, _downloadFile, value.media_assets),
...
async function from_candid_record_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        to: record_opt_to_undefined(from_candid_opt_n25(_uploadFile, _downloadFile, value.to)),
        ...
        from: record_opt_to_undefined(from_candid_opt_n25(_uploadFile, _downloadFile, value.from)),
        user: value.user,
        nftId: value.nftId,
...
async function from_candid_record_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        profileImage: record_opt_to_undefined(await from_candid_opt_n31(_uploadFile, _downloadFile, value.profileImage)),
...
async function from_candid_record_n39(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    discountCode: string;
    metadata: _PublicORIGYNMetadata;
    user: Principal;
    nftId: bigint;
    timestamp: _Time;
}): Promise<{
    ...
    return {
        ...
        metadata: await from_candid_PublicORIGYNMetadata_n35(_uploadFile, _downloadFile, value.metadata),
        user: value.user,
        nftId: value.nftId,
        timestamp: value.timestamp
    };
...
async function from_candid_record_n45(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    redeemed: boolean;
    name: string;
    origyn_metadata: _PublicORIGYNMetadata;
    certification: string;
    mystery: boolean;
    asset_class: string;
    issue_date: string;
    ...
    return {
        ...
        redeemed: value.redeemed,
        name: value.name,
        origyn_metadata: await from_candid_PublicORIGYNMetadata_n35(_uploadFile, _downloadFile, value.origyn_metadata),
        certification: value.certification,
        mystery: value.mystery,
        asset_class: value.asset_class,
        issue_date: value.issue_date,
...
async function from_candid_vec_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_TransactionRecord>): Promise<Array<TransactionRecord>> {
    return await Promise.all(value.map(async (x)=>await from_candid_TransactionRecord_n23(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PublicORIGYNMetadata>): Promise<Array<PublicORIGYNMetadata>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PublicORIGYNMetadata_n35(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n37(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_RedemptionRecord>): Promise<Array<RedemptionRecord>> {
    return await Promise.all(value.map(async (x)=>await from_candid_RedemptionRecord_n38(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n40(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PublicTransactionRecord>): Promise<Array<PublicTransactionRecord>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PublicTransactionRecord_n41(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n43(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PublicNFTData>): Promise<Array<PublicNFTData>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PublicNFTData_n44(_uploadFile, _downloadFile, x)));
}
